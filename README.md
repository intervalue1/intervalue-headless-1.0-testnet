...
Use TOR ([conf.socksHost, conf.socksPort, and conf.socksLocalDNS](../../../intervaluecore-1.0-testnet#confsockshost-confsocksport-and-confsockslocaldns)) to hide your server IP address from potential attackers.
