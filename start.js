...
var desktopApp = require('intervlauecore-1.0-testnet/desktop_app.js');
var db = require('intervlauecore-1.0-testnet/db.js');
var eventBus = require('intervlauecore-1.0-testnet/event_bus.js');
var ecdsaSig = require('intervlauecore-1.0-testnet/signature.js');
...
function createWallet(xPrivKey, onDone){
	...
	var device = require('intervlauecore-1.0-testnet/device.js');
	...
	readKeys(function(mnemonic_phrase, passphrase, deviceTempPrivKey, devicePrevTempPrivKey){
		...
		readSingleWallet(function(wallet){
			...
			db.query("SELECT 1 FROM extended_pubkeys WHERE device_address=?", [my_device_address], function(rows){
				...
				require('intervlauecore-1.0-testnet/wallet.js'); // we don't need any of its functions but it listens for hub/* messages
				...
				if (conf.bLight){
					var light_wallet = require('intervlauecore-1.0-testnet/light_wallet.js');
